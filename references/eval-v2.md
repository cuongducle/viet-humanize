...
|---|---|---|---|---|
| `bien_dong_do_dai_cau_cv` | 0.993 | ng>AI | 0.43 | 0.22 |
| `ty_le_tu_rieng_ttr_am_tiet` | 0.915 | AI>ng | 0.62 | 0.74 |
| `mattr_cua_so_50` | 0.902 | AI>ng | 0.86 | 0.92 |
| `entropy_dau_cau_bit` | 0.748 | ng>AI | 1.33 | 1.00 |
| `do_nen_zlib` | 0.730 | AI>ng | 0.53 | 0.57 |
| `diem_scan` | 0.620 | ng>AI | 1.00 | 0.00 |
| `dai_cau_tb` | 0.620 | ng>AI | 27.80 | 25.60 |
| `lech_do_dai_cau_skew` | 0.613 | ng>AI | 0.55 | 0.35 |
| `han_viet_lex/1k` | 0.608 | AI>ng | 3.12 | 5.68 |
| `cau_trung_binh_doan` | 0.586 | ng>AI | 9.00 | 7.00 |
| `tu_chuc_nang` | 0.578 | ng>AI | 0.21 | 0.19 |
...
| `bien_dong_do_dai_cau_cv` | 1.000 | ng>AI | 0.54 | 0.14 |
| `mattr_cua_so_50` | 0.990 | AI>ng | 0.90 | 0.95 |
| `entropy_dau_cau_bit` | 0.938 | ng>AI | 1.40 | 1.00 |
| `diem_scan` | 0.764 | ng>AI | 2.00 | 0.00 |
| `lech_do_dai_cau_skew` | 0.750 | ng>AI | 0.63 | -0.19 |
| `lien_tu_hinh_thuc_tren_1000` | 0.726 | ng>AI | 2.10 | 0.00 |
| `dai_cau_tb` | 0.715 | AI>ng | 22.90 | 25.60 |
| `han_viet_lex/1k` | 0.681 | AI>ng | 4.34 | 10.75 |
| `tu_chuc_nang` | 0.667 | ng>AI | 0.22 | 0.20 |
| `tro_tu_cuoi_cau_tren_1000` | 0.649 | ng>AI | 0.00 | 0.00 |
| `pho_tu/1k` | 0.566 | ng>AI | 4.22 | 0.00 |
