...
- Thu 77 bài Threads Việt Nam và 12 bộ trả lời bằng Chrome thật (browser-skill) đúng quy trình của mục 14, trong ba đợt cùng ngày, phủ 19 nhóm chủ đề đời sống; 30 cặp AI cùng chủ đề viết ở chế độ mặc định. Script `research/eval_threads.py`, báo cáo `references/eval-threads.md`, nguồn corpus trong `corpus/v4-threads/manifest.md`.
- Kết quả chính: zlib 0,920 (người 0,74 cao hơn AI 0,58), ổn định qua ba lần đo; TTR toàn cục nghiêng về người (0,757) ngược register báo chí, MATTR-50 vẫn AI cao hơn (0,697); Hán Việt trừu tượng 0,762 (AI 5,75/1000, người 0); phó từ cường độ 0,706 (AI 11,49, người 0). CV độ dài câu về 0,512: không phải tín hiệu của register chat. Fightin' words: đối lập xưng hô mình/tao/t (người) với tôi (AI); thêm hai dấu hiệu viết của người là viết tắt xưng hô và dùng số thẳng thay chữ.
- B8 (trợ từ cuối câu): bài dài người 27/77 file có (35%), AI 3/30 (10%); replies 7/12 bộ có, trung vị 3,7, tối đa 57,1/1000. Kết luận: B8 là tín hiệu đã đo cho register chat, hiện tượng có/không tách rõ hơn mật độ; không dùng làm dấu hiệu quyết định.
- Đợt 4 (Chrome đứt kết nối liên tục): lấy ViHSD đo đối chiếu tầng trả lời ngắn — 16.319 comment CLEAN của Facebook/YouTube, chỉ dùng số tổng hợp, không đưa văn bản vào repo. Kết quả: 8,0% comment có trợ từ, trung vị 0/1000, nhóm có trung vị 90,9/1000. Khớp kết luận Threads: trợ từ là hiện tượng có/không của register chat. Việc lấy thêm replies Threads chủ đề trung tính còn treo tới khi Chrome ổn.
